...
import { View, Platform, Text, ToastAndroid, Image, StyleSheet } from 'react-native';
import CustomButton from 'react-native-really-awesome-button';
import logo from './res/retro.png'
...
export default class Board extends Component {
    constructor(props) {
        ...
        this.throttledClick = _.throttle(this.clickyClick, 1000, );
